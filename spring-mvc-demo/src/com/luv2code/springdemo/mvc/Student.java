...
public class Student {
	...
	public Student() {
		...
		// in the dropdown only the values will be presented 
		// and the key will be present in student confirmation page
		...
		genderOptions.put("Not specified", "Not specified");
	}
